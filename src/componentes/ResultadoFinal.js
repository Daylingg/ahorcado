        ...
        {!cargando ? (
          <div id=" contenedor-nuevo-juego" className=" new-game">
            <div id="texto-resultante">
              <h2 className="lose-msg">Has Perdido 😢 !!!</h2>
              <p>
                La palabra era: <span>{palabra}</span>
              </p>
            </div>
            <div id="container-button">
              <button id="new-game-button" onClick={inicio}>
                Inicio
              </button>
              <button id="game-button" onClick={reiniciar}>
                Reiniciar Juego
              </button>
            </div>
          </div>
        ) : (
          <div className=" new-game cargando">Cargando...</div>
        )}
      </>
    )
  } else {
      ...
      return (
        <>
          {!cargando ? (
            <div id=" contenedor-nuevo-juego" className=" new-game">
              <div id="texto-resultante">
                <h2 className="win-msg">Has Ganado 🤩 !!!</h2>
                <p>
                  La palabra era: <span>{palabra}</span>
                </p>
              </div>
            ...
            <div className=" new-game-popup cargando">Cargando...</div>
          )}
        </>
      )
    }
